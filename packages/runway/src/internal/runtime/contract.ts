...
export const DATA_BUCKET = "runway-data";
export const STATE_BUCKET = "runway-state";
export const DATA_BUCKET_BINDING = "RUNWAY_DATA";
export const RUNTIME_BINDING = "RUNWAY_RUNTIME";
export const RELEASE_TOKEN_BINDING = "RUNWAY_RELEASE_TOKEN";
export const SECRET_SNAPSHOT_KEY_BINDING = "RUNWAY_SECRET_SNAPSHOT_KEY";
export const CACHE_R2_ACCESS_KEY_ID_BINDING = "RUNWAY_CACHE_R2_ACCESS_KEY_ID";
export const CACHE_R2_SECRET_ACCESS_KEY_BINDING = "RUNWAY_CACHE_R2_SECRET_ACCESS_KEY";
export const CACHE_R2_SESSION_TOKEN_BINDING = "RUNWAY_CACHE_R2_SESSION_TOKEN";
export const CACHE_SECRET_BINDINGS = [
