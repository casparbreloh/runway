          ...
          workers: [
            ...
            },
            {
              ...
              bindings: {
                ...
                RUNWAY_RELEASE_TOKEN: "release-token",
...
export class TestWorkflowCapture extends WorkerEntrypoint {
  ...
  reset() { captured = undefined; }
          ...
          bindings: {
            ...
            ACTIVE_REGISTRY: new TextDecoder().decode(generated.registryContents),
            ACTIVE_REGISTRY_VERSION: generated.registryVersion,
            ...
            GITHUB_REGISTRY: new TextDecoder().decode(githubHost.registryContents),
            GITHUB_REGISTRY_VERSION: githubHost.registryVersion,
            MANY_GITHUB_REGISTRY: new TextDecoder().decode(manyGithubHost.registryContents),
            MANY_GITHUB_REGISTRY_VERSION: manyGithubHost.registryVersion,
          },
          r2Buckets: { RUNWAY_DATA: "runway-test-artifacts" },
          serviceBindings: {
            GITHUB_HOST: {
